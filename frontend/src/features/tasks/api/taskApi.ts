...
export const taskApi = {
  ...
  deleteTask: (taskId: string) => apiClient.delete<void>(API_ENDPOINTS.TASKS.DELETE(taskId)),
  ...
  completeTask: (taskId: string, userId: string, note?: string) => apiClient.post<Task>(API_ENDPOINTS.TASKS.COMPLETE_TASK(taskId), { userId, note }),
};
